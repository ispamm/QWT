...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="dwt",help='')
    parser.add_argument('--seed', type=int, default=888, help='seed')
    parser.add_argument('--lr', type=float, default=1e-6, help='learning rate')
    args = parser.parse_args()

    pl.seed_everything(args.seed) #set_deterministic(seed=args.seed)
    model = ImageFusionNetworkPL(in_channels=3, 
                                 out_channels=3,
    ...
    if args.dataset =="ixi":
        ...
        ixi_data = CelebADataModule(data_dir='/home/luigi/Documents/swagan/datasets/celeba_1024')
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath="/home/luigi/Documents/tests/results/checkpoints",
